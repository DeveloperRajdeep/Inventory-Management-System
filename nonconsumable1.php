...
<title>NON CONSUMABLE ORDER</title>
...
function get_subcategory(c_id)
{
    ...
    $.ajax({
       type: "POST",
       url: "subcategory1.php", /* The country id will be sent to this file */
       beforeSend: function () {
        },
       data: "c_id="+i_id,
...
<body>
<form action="ordercon.php" target='_blank' onsubmit="return validForm()" method="GET">
<div id="apDiv1">
 <div id="apDiv2">
    <div id="apDiv90"><img src="niclogo.png" width="233" height="55" /></div>
    <div id="apDiv4">
  ...
  <div id="apDiv11">
    ...
    <table width="843" height="171">
      <tr>
        <td width="138">Serial No.</td>
        <td width="151">Item Name</td>
        <td width="312">Quantity</td>
        <td width="210">Available</td>
      </tr>
      <?php
  $i=1;
  $count=1;
  while($i<=$a)
  {
      ...
      <tr>
		...
		<td>
		  ...
		  $sql1=mysql_query("select * from nonconsumable ");
          ...
          <td>
          <input type="text" id='quantity<?php echo $i?>' name="quantity[<?php echo $i?>]">/pack
		  ...
		  <td width="8"><label id="report<?php echo $i?>"></label></td>
      </tr>
      <?php 
	  $i++;
  }
  ?>
    ...
    <div id="apDiv17" align="center">
      <div id="apDiv18">
       ...
       <div id="apDiv91">
          <a href="nonconsumable1.php?nonconsumableitem=<?php if(isset($_GET['nonconsumableitem'])){ echo $_GET['nonconsumableitem']+1;} ?>&submit=Submit"><input type="button" name="button3" id="button3" class="styled-button-2" value="Add+" style="position:absolute;top:205px;left:560px;" /></a>
        </div>
      </div>
      <div id="apDiv19">
      
       <a href="nonconsumable1.php?nonconsumableitem=<?php if(isset($_GET['nonconsumableitem']) && $_GET['nonconsumableitem']>1){ echo $_GET['nonconsumableitem']-1;}else{ echo 1; } ?>&submit=Submit"> <input type="button" name="remove" class="styled-button-1" id="button2" value="Remove Item-" /></a>
      
      </div>
    </div>
   
  </div>
  <div id="apDiv20"><a href="home.php"><img src="home_button.png" width="169" height="57" /></a></div>
</div>
<?php
$sql1=mysql_query("select DISTINCT(requistion_no) from orders where type='nonconsumable' ORDER BY requistion_no DESC LIMIT 1");
...
<div id="apDiv8">
  ...
  <div id="apDiv10">Non Consumable</div>
</div>
</form>
</body>
</html>