...
<div id="apDiv1">
  <div id="apDiv2">
    ...
    <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
      <table width="330" height="562">
        <tr>
          <td><label for="textfield"></label>
          <input type="text" required='required' placeholder="Enter Your Full Name" name="fullname" class="txtGen"  id="textfield" /></td>
        </tr>
        <tr>
          <td><input type="text" required='required'  placeholder="Enter Your Employee Id" class="txtGen" name="employeeid" id="textfield2" /></td>
        </tr>
        <tr>
          <td><input type="text" required='required' placeholder="Enter Your Department Name" class="txtGen" name="department" id="textfield3" /></td>
        </tr>
        <tr>
          <td><input type="text" required='required' placeholder="Enter Your Designation" class="txtGen" name="designation" id="textfield4" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><input type="text"  required='required' placeholder="Enter Security Answer" class="txtGen" name="securityans" id="textfield8" /></td>
        </tr>
        <tr>
          <td height="33"><input type="submit" class="styled-button-1" name="register" id="button" value="Register" /></td>
        </tr>
        <tr>
          <td height="22"><div id="apDiv5"><a style="text-decoration:none;" href="login1.php">I already have an account</a></div>
  ...
  <div id="apDiv3">Register New Employee</div>
</div>
</body>
</html>