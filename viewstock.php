...
<a href="index.htm"><img src="logo.png"  alt=""></a> 
  ...
  <div id="apDiv8">
    <div id="apDiv9"><a href="stockconsumable.php"><p class="p">Consumable Items</p></a></div>
    <div id="apDiv10"><a href="stocknonconsumable.php"><p class="p">Non Consumable Items</p></a></div>
    <div id="apDiv12">Available Stock Items</div>
  </div>
  <div id="apDiv3">
