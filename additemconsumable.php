...
<div id="apDiv2">
<div id="apDiv1">
<form action="doadditemconsumable.php" method="post">
  <table width="444" height="172">
    <tr>
      ...
      <td width="211"><label for="textfield"></label>
        <input type="text" name="qname" class="txtGen" placeholder="Enter Item Name" id="textfield"  required="required"></td>
      </tr>
    <tr>
      ...
      <td><input type="text" name="noquan" class="txtGen" id="textfield2" pattern="[0-9]{2}" placeholder="Enter Item Quantity" required="required"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <div id="apDiv3">Adding Consumable Items To Stock</div>
</div>
