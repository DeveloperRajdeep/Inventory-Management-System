...
<div id="apDiv1">
  <div align="center">
    <table width="824" style="border-style: inset;" height="176">
      <tr>
        ...
        <td width="68">Type</td>
        <td width="103">Approve</td>
        <td width="96">Deny</td>
      </tr>
      <?php
  $sql="select * from orders where status='pending'  AND type='nonconsumable'";
  $res=mysql_query($sql);
  ...
  ?>
      <tr>
        ...
        <td width="103"><a href="approve1.php?a=<?php echo $row["id"] ?>">APPROVE</a></td>
        <td width="96"><a href="deny1.php?b=<?php echo $row["id"]?>">DENY</a></td>
      </tr>
      <?php
      }
	  ?>
