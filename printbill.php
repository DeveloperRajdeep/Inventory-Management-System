...
#apDiv1 #apDiv8 #apDiv10 table tr td {
	font-family: Arial, Helvetica, sans-serif;
}
#apDiv1 #apDiv8 #apDiv10 table {
	font-size: 16px;
...
#apDiv1 #apDiv8 #apDiv11 form table tr td label {
	font-family: Verdana, Geneva, sans-serif;
}
#apDiv1 #apDiv8 #apDiv11 form table tr td label {
	font-size: 16px;
...
<li><a href="#">&nbsp;</a></li>
  ...
  <div id="apDiv8">
    <div id="apDiv11">
    <form action="reprntordercon1.php" target="_blank" method='GET'>
      <label for="textfield"></label>
      <table width="617">
        <tr>
          <td width="241"><label for="textfield2"></label>
          <input type="text" name="bill_no" id="textfield2" required="required" class="txtGen" placeholder="Enter Requistion No." />
          </td>
          <td width="226"><label for="select"></label>
            <select name="bn" class="txtGen" id="select">
             <option value=' '>Choose Type:</option>
               <option value="consumable">Consumable</option>
           <option value="nonconsumable">Non Consumable</option>
          </select></td>
          <td width="134"><input type="submit" name="submit"  class="styled-button-1" value="Print" /></td>
        </tr>
      </table>
      </form>
...
<label for="select"></label>
    ...
    <div id="apDiv9">Print Your Bill</div>
  </div>
  <div id="apDiv3">
