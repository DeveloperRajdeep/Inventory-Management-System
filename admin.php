    ...
    <div id="apDiv9">
      <table width="429" height="165">
       <tr>
        ...
        <td width="199" style="font-family: Verdana, Geneva, sans-serif; font-weight: normal;text-align: center;"><?php echo $user ?></td>
      </tr>
      <tr>
        ...
        <td style="font-family: Verdana, Geneva, sans-serif; font-weight: normal;text-align: center;">*****</td>
      </tr>
        <tr>
        <td></td>
          <td>&nbsp;</td>
          <td><a href="updateadmin.php?a=<?php echo $rs[0]?>"><input type="submit" name="button2" class="styled-button-3" id="button2" value="Update Details" /></td>
        </tr>
      </table>
    </div>
