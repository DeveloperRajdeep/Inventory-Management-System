...
<li><a href="#">&nbsp;</a></li>
  ...
  <div id="apDiv7">
  <form action="consumable1.php" method="GET"> 
    <table width="327" height="112">
      <tr>
        <td width="377"><label for="textfield"></label>
          <input type="text" name="consumableitem" id="textfield" class="txtGen" required="required" placeholder="Number of Consumable Items" /></td>
      </tr>
      <tr>
